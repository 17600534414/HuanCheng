...
public class ExpandableTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        setMaxLines(lineNum);
        bitmapDown = BitmapFactory.decodeResource(getResources(), R.mipmap.detai_down);
        bitmapUp = BitmapFactory.decodeResource(getResources(),  R.mipmap.detai_us);
        w = bitmapDown.getWidth() +50 ;
        h = bitmapDown.getHeight() +50;
