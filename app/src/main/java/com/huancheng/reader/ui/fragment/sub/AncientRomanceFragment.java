...
public class AncientRomanceFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public AncientRomanceFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        ...
        list.add(new ManPublicBean(R.mipmap.book_book,"古代言情1","古代言情介绍1",R.mipmap.login_code2,"古代言情个人昵称1"));
        list.add(new ManPublicBean(R.mipmap.book_book,"古代言情2","古代言情介绍2",R.mipmap.login_code2,"古代言情个人昵称2"));
        list.add(new ManPublicBean(R.mipmap.book_book,"古代言情3","古代言情介绍3",R.mipmap.login_code2,"古代言情个人昵称3"));
