...
public class EndManFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public EndManFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        ...
        list.add(new ManPublicBean(R.mipmap.book_book,"男生1","男生介绍1",R.mipmap.login_code2,"男生个人昵称1","类型1"));
        list.add(new ManPublicBean(R.mipmap.book_book,"男生2","男生介绍2",R.mipmap.login_code2,"男生个人昵称2","类型2"));
        list.add(new ManPublicBean(R.mipmap.book_book,"男生3","男生介绍3",R.mipmap.login_code2,"男生个人昵称3","类型3"));
