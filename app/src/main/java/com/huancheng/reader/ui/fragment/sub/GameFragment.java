...
public class GameFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public GameFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        list.add(new ManPublicBean(R.mipmap.book_book,"游戏竞技1","游戏竞技介绍1",R.mipmap.login_code2,"游戏竞技个人昵称1"));
        list.add(new ManPublicBean(R.mipmap.book_book,"游戏竞技2","游戏竞技介绍2",R.mipmap.login_code2,"游戏竞技个人昵称2"));
        list.add(new ManPublicBean(R.mipmap.book_book,"游戏竞技3","游戏竞技介绍3",R.mipmap.login_code2,"游戏竞技个人昵称3"));
