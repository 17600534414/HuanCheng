...
public class KnightErrantFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public KnightErrantFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        list.add(new ManPublicBean(R.mipmap.book_book,"武侠仙侠1","武侠仙侠介绍1",R.mipmap.login_code2,"武侠仙侠个人昵称1"));
        list.add(new ManPublicBean(R.mipmap.book_book,"武侠仙侠2","武侠仙侠介绍2",R.mipmap.login_code2,"武侠仙侠个人昵称2"));
        list.add(new ManPublicBean(R.mipmap.book_book,"武侠仙侠3","武侠仙侠介绍3",R.mipmap.login_code2,"武侠仙侠个人昵称3"));
