...
public class FantasyRomanceFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public FantasyRomanceFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        ...
        list.add(new ManPublicBean(R.mipmap.book_book,"幻想言情1","幻想言情介绍1",R.mipmap.login_code2,"幻想言情个人昵称1"));
        list.add(new ManPublicBean(R.mipmap.book_book,"幻想言情2","幻想言情介绍2",R.mipmap.login_code2,"幻想言情个人昵称2"));
        list.add(new ManPublicBean(R.mipmap.book_book,"幻想言情3","幻想言情介绍3",R.mipmap.login_code2,"幻想言情个人昵称3"));
