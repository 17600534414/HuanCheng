...
public class GirlSuspenseFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public GirlSuspenseFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        ...
        list.add(new ManPublicBean(R.mipmap.book_book,"女生悬疑1","女生悬疑介绍1",R.mipmap.login_code2,"女生悬疑个人昵称1"));
        list.add(new ManPublicBean(R.mipmap.book_book,"女生悬疑2","女生悬疑介绍2",R.mipmap.login_code2,"女生悬疑个人昵称2"));
        list.add(new ManPublicBean(R.mipmap.book_book,"女生悬疑3","女生悬疑介绍3",R.mipmap.login_code2,"女生悬疑个人昵称3"));
