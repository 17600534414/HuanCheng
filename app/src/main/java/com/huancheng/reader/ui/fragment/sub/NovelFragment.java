...
public class NovelFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public NovelFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        list.add(new ManPublicBean(R.mipmap.book_book,"科幻小说1","科幻小说介绍1",R.mipmap.login_code2,"科幻小说个人昵称1"));
        list.add(new ManPublicBean(R.mipmap.book_book,"科幻小说2","科幻小说介绍2",R.mipmap.login_code2,"科幻小说个人昵称2"));
        list.add(new ManPublicBean(R.mipmap.book_book,"科幻小说3","科幻小说介绍3",R.mipmap.login_code2,"科幻小说个人昵称3"));
