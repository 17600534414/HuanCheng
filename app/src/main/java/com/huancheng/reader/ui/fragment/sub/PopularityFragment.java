...
public class PopularityFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public PopularityFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        ...
        list.add(new ManPublicBean(R.mipmap.book_book,"男生1","人气新书榜1",R.mipmap.login_code2,"男生个人昵称1","类型1",R.mipmap.login_code1));
        list.add(new ManPublicBean(R.mipmap.book_book,"男生2","人气新书榜2",R.mipmap.login_code2,"男生个人昵称2","类型2",R.mipmap.login_code1));
        list.add(new ManPublicBean(R.mipmap.book_book,"男生3","人气新书榜3",R.mipmap.login_code2,"男生个人昵称3","类型3",R.mipmap.login_code1));
