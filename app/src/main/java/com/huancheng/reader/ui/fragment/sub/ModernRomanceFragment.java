...
public class ModernRomanceFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public ModernRomanceFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        ...
        list.add(new ManPublicBean(R.mipmap.book_book,"现代言情1","现代言情介绍1",R.mipmap.login_code2,"现代言情个人昵称1"));
        list.add(new ManPublicBean(R.mipmap.book_book,"现代言情2","现代言情介绍2",R.mipmap.login_code2,"现代言情个人昵称2"));
        list.add(new ManPublicBean(R.mipmap.book_book,"现代言情3","现代言情介绍3",R.mipmap.login_code2,"现代言情个人昵称3"));
