...
public class FantasyFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public FantasyFragment(Context context, int resId, String type, int code) {
        super(context, resId);
        _context = context;
        this.type = type;
        this.code = code;
...
//        list.add(new ManPublicBean(R.mipmap.book_book,"玄幻奇幻1","玄幻奇幻介绍1",R.mipmap.login_code2,"玄幻奇幻个人昵称1"));
//        list.add(new ManPublicBean(R.mipmap.book_book,"玄幻奇幻2","玄幻奇幻介绍2",R.mipmap.login_code2,"玄幻奇幻个人昵称2"));
//        list.add(new ManPublicBean(R.mipmap.book_book,"玄幻奇幻3","玄幻奇幻介绍3",R.mipmap.login_code2,"玄幻奇幻个人昵称3"));
