...
public class MalegodHotFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public MalegodHotFragment(Context context, int resId) {
        super(context, resId);
        _context = context;
    }
    ...
    protected void initData() {
        ...
        list.add(new ManPublicBean(R.mipmap.book_book,"男生1","男神热搜榜1",R.mipmap.login_code2,"男生个人昵称1","类型1",R.mipmap.login_code1));
        list.add(new ManPublicBean(R.mipmap.book_book,"男生2","男神热搜榜2",R.mipmap.login_code2,"男生个人昵称2","类型2",R.mipmap.login_code1));
        list.add(new ManPublicBean(R.mipmap.book_book,"男生3","男神热搜榜3",R.mipmap.login_code2,"男生个人昵称3","类型3",R.mipmap.login_code1));
